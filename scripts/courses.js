...
function createCourses(courses) {
    ...
    courses.forEach(course => {
        ...
        //dialog.id = `dialog-card-${course.number}`;
        ...
        // IMPORTANT: To select correctly the element.
...
function createCourses(courses) {
    ...
    courses.forEach(course => {
        ...
        // Append the card and dialog to the container
        container.appendChild(card);
        container.appendChild(dialog);

        // Get the specific dialog and button for each course
        const openModal = card.querySelector(".open-button");
        const closeModal = dialog.querySelector(".close-button");
        ...
        const allCredits = document.querySelector("#totalCredits");
        allCredits.innerHTML = `The total credits for courses listed above is ${totalCredits} (${obtainedCredits} obtained)`;
